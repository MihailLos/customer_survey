...
# --- Страница 1: Вопросы 1–3 ---
    ...
    sqt.triple_text_input("f_q3", "q3", "Вопрос 3. Напишите, какие 3 элемента маркировки, по Вашему мнению, должны быть выделены наиболее заметно на упаковке любой пищевой продукции?", ["Элемент 1:", "Элемент 2:", "Элемент 2:"])
    with st.form("f_q3"):
