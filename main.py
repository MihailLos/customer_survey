...
# --- Страница 1: Вопросы 1–3 ---
    ...
    q2_options = st.multiselect("2. Где чаще всего Вы приобретаете пищевую продукцию?",
                   ["Супермаркеты", "Магазины 'у дома'", "Ларьки/киоски", "Рынки", 
                    "Онлайн-сервисы доставки", "Другое"], key="q2")
    if "Другое" in q2_options:
...
# --- Страница 3: Вопросы 13–19 ---
    ...
    q17_options = st.multiselect("17. Какой информацией Вы хотели бы пользоваться при выборе продукции?",
                   ["Рейтинги качества", "Сравнение цен", "Анализ состава", "Отзывы", 
                    "Рекомендации по здоровому питанию", "Другое"], key="q17")
    if "Другое" in q17_options:
