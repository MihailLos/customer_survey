...
# --- Страница 1: Вопросы 1–3 ---
    ...
    st.multiselect("2. Где чаще всего Вы приобретаете пищевую продукцию?",
...
# --- Страница 3: Вопросы 13–19 ---
    ...
    st.multiselect("17. Какой информацией Вы хотели бы пользоваться при выборе продукции?",
